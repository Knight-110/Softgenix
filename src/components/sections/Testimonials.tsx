...
const quotes = [
  {
    q: "Softgenix shipped a product that genuinely felt like Apple-level polish. Conversion is up 3.2× since launch.",
    a: "Priya Menon",
      ...
      <div className="container">
        <div className="max-w-3xl reveal">
          <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full glass text-[11px] tracking-[0.3em] uppercase text-muted-foreground">
            <span className="h-1.5 w-1.5 rounded-full bg-cyan" /> Testimonials
          </span>
          <h2 className="mt-6 font-display text-4xl md:text-6xl font-bold leading-[1.05]">
            Founders who chose us<br /><span className="text-gradient-brand">said this.</span>
          </h2>
        </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-5">
          {quotes.map((t, i) => (
            ...
            >
              ...
              <blockquote className="mt-5 text-foreground/90 leading-relaxed text-[15px]">
                "{t.q}"
              </blockquote>
